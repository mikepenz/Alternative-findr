...
public class AboutActivity extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((TextView) v.findViewById(R.id.frag_info_textview)) .setText(Html.fromHtml(getString(R.string.abouttext)));
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.item_info:
			...
			intent.setClass(AboutActivity.this, InfoActivity.class);
