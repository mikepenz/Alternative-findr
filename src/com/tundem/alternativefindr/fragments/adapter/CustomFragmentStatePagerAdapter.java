...
public abstract class CustomFragmentStatePagerAdapter extends PagerAdapter {
	...
	public void destroyItem(ViewGroup container, int position, Object object) {
		...
		/* if (mCurTransaction == null) { mCurTransaction = mFragmentManager.beginTransaction(); } if (DEBUG) Log.v(TAG, "Removing item #" + position
		 * + ": f=" + object + " v=" + ((Fragment) object).getView()); while (mSavedState.size() <= position) { mSavedState.add(null); }
